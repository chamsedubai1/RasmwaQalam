...
async function saveMissionImage() {
  try {
    ...
    const response = await hf.textToImage({
      ...
      parameters: {
        negative_prompt:
          "blurry, bad quality, low resolution, ugly, disfigured",
      },
    });
