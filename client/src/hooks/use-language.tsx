...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "home.airobot.description": "Experience the fusion of artificial intelligence and human creativity. Our advanced AI technologies help students explore new artistic possibilities and develop innovative skills for the future.",
  ...
  ar: {
    ...
    "home.airobot.description": "اختبر الاندماج بين الذكاء الاصطناعي والإبداع البشري. تساعد تقنيات الذكاء الاصطناعي المتقدمة لدينا الطلاب على استكشاف إمكانيات فنية جديدة وتطوير مهارات مبتكرة للمستقبل.",
